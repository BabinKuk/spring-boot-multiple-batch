package org.babinkuk.batch.config.quartz;
...
public class QuartzConfig {
	...
	public Trigger job1Trigger(JobDetail job1Detail) {
	    return TriggerBuilder.newTrigger()
			...
			.withSchedule(CronScheduleBuilder.cronSchedule("0/10 * * * * ?")) // runs every 10s
			.build();
	}
	...
	public Trigger job2Trigger(JobDetail job2Detail) {
		return TriggerBuilder.newTrigger()
			...
			.withSchedule(CronScheduleBuilder.cronSchedule("0/15 * * * * ?")) // runs every 15s
			.build();
	}
