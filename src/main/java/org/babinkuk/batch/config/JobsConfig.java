...
public class JobsConfig {
	...
	private static final Logger log = LoggerFactory.getLogger(JobsConfig.class);
	 ...
	 * simple task logging hello message and returning status as FINISHED
	 * 
	 * @param jobRepository
	...
	/**
	 * Batch job step implementation
	 * simple task logging world message and returning status as FINISHED
	 * 
	 * @param jobRepository
	 * @param transactionManager
	 * @return
